...
void main() {
  group('Environment Widgets Tests', () {
    ...
    testWidgets(
      'EnvironmentSelectorChip renders active workspace and opens sheet on tap',
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              appBar: AppBar(
                actions: [
                  EnvironmentSelectorChip(environmentController: controller),
                ],
              ),
            ),
          ),
    ...
    testWidgets(
      'CreateEnvironmentModal validates input length and calls controller',
      (WidgetTester tester) async {
        await controller.initialize('u1');
    ...
    testWidgets(
      'EnvironmentInvitationTile renders invitation details and triggers callbacks',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'MigrateContentDialog triggers onMigrateAndProceed on confirmation',
      (WidgetTester tester) async {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final sharedEnv = controller.environments.firstWhere(
          (e) => !e.isPersonal,
        );
